...
(function (k) {
  ...
  var xc = function (a, b, c, d) {
      ...
      b._details = k(e);
      b._details && b._details.insertAfter(b.nTr);
    },
    xb = function (a, b) {
      var c = a.context;
      c.length &&
        ...
        a._details &&
        (a._details.remove(), (a._details = q), (a._details = q));
    },
    pc = function (a, b) {
      var c = a.context;
      c.length &&
        ...
        (b.on("draw.dt.DT_details", function (d, e) {
          a === e &&
            b
              ...
              .each(function (f) {
                f = c[f];
                f._details && f._details.insertAfter(f.nTr);
              });
        }),
  ...
  w("row().child.isn()", function () {
    var a = this.context;
    return a.length && this.length ? a[0].aoData[this[0]]._details || !1 : !1;
  });
